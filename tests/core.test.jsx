...
import { useMapLogic } from '../src/core/hooks/useMapLogic';
...
vi.mock('../src/app-system/GoogleStadiumMap', () => ({ 
...
vi.mock('../src/app-system/NavigationPanel', () => ({ 
    default: () => <div>Precision Navigation</div> 
}));
vi.mock('../src/app-system/SmartReturnPanel', () => ({ 
    default: () => <div>Smart Return Panel</div> 
}));
vi.mock('../src/app-system/LoginScreen', () => ({ 
    default: () => <div>Login Screen</div> 
}));
vi.mock('../src/app-system/StadiumMap', () => ({ 
