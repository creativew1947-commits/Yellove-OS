...
vi.mock('../src/app-system/NavigationPanel', () => ({ default: () => <div data-testid="navigation-panel">Navigation</div> }));
vi.mock('../src/app-system/SmartReturnPanel', () => ({ default: () => <div data-testid="smart-return">Return</div> }));
